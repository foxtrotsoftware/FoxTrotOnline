...
<div class="container-fluid">
	<div class="row">
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			...
			<div class="row">
                <div class='col-sm-4' style="cursor: pointer;" id="trades_on_hold" onclick="open_currentreport_box(this.id);">
					<div class='alert rp_section alert-warning1 rp_active'>
						<strong>Trades On Hold</strong>
					</div>
				</div>
				<div class='col-sm-4' style="cursor: pointer;" id="ytd_earnings" onclick="open_currentreport_box(this.id);">
					<div class='alert rp_section alert-info'>
						<strong>Year to Date Earnings</strong>
					</div>
				</div>
				<div class='col-sm-4' style="cursor: pointer;" id="current_licensing" onclick="open_currentreport_box(this.id);">
					<div class='alert rp_section alert-info'>
						<strong>Current Licensing</strong>
					</div>
				</div>
            </div>
            <div id="trades_on_hold_section">
			<div class="row">
			...
			<div class="row">
				<form id="ytd_earnings_form" class="col-md-12 dates_form ytd_date_form">
					...
					<div class="custom-control custom-checkbox">
						...
						<label class="custom-control-label" for="ytd_earnings_all_dates_checkbox">All Payroll Dates</label>
					</div>
					<label>From</label>
